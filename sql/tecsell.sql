...
--
-- Host: 127.0.0.1
-- Tempo de geração: 19-Out-2021 às 21:09
...
CREATE TABLE `cadastro_produto` (
  ...
  `preco_produto` varchar(14) NOT NULL,
...
INSERT INTO `cadastro_usuarios` (`cpf_usuario`, `status_usuario`, `nome_usuario`, `sobrenome_usuario`, `telefone_usuario`, `email_usuario`, `senha_usuario`, `foto_usuario`, `data_cadastro_usuario`) VALUES
('222.222.222-22', 'Ativo', 'Eliel', 'Nunes Pinto', '(22) 222222222', 'elielnunes@gmail.com', '123456', 'fotos/sistema/usuariosemfoto.jpg', '2021-10-05 15:17:47'),
('111.111.111-11', 'Ativo', 'João', 'Rodrigues Parra', '(11) 111111111', 'j-r-p@outlook.com', '123456', './fotos/usuarios/foto_051020211216261422.jpg', '2021-10-05 14:35:21'),
('333.333.333-33', 'Ativo', 'Miriã', 'Parra', '(12) 996291803', 'mirisa03@gmail.com', '123456', './fotos/usuarios/foto_191020210302221355.jpg', '2021-10-06 13:09:50');
...
(1, 1, 4, 33, 116, '32', '2', '16', '5'),
(2, 2, 2, 19, 83, '64', '2', '12', '5');

-- --------------------------------------------------------

--
-- Estrutura da tabela `fichatec_notebook`
--

CREATE TABLE `fichatec_notebook` (
  `cod_ficha_tec` int(11) NOT NULL,
  `cod_anuncio` int(11) DEFAULT NULL,
  `memoria_ram` varchar(10) NOT NULL,
  `memoria_armazenamento` varchar(10) NOT NULL,
  `processador` varchar(100) NOT NULL,
  `cod_modelo_notebook` int(11) DEFAULT NULL,
  `cod_marca_notebook` int(11) DEFAULT NULL,
  `cod_linha_notebook` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1, 1, './fotos/produtos/foto_0510202112130410.jpg'),
(2, 1, './fotos/produtos/foto_0510202112130411.jpg'),
(3, 1, './fotos/produtos/foto_0510202112130412.jpg'),
(4, 1, './fotos/produtos/foto_0510202112130413.jpg'),
(5, 1, './fotos/produtos/foto_0510202112130414.jpg'),
(6, 2, './fotos/produtos/foto_0510202112224220.jpg');
...
--
-- Índices para tabela `fichatec_notebook`
--
ALTER TABLE `fichatec_notebook`
  ADD PRIMARY KEY (`cod_ficha_tec`),
  ADD KEY `fichatec_notebook_cadastro_produto` (`cod_anuncio`),
  ADD KEY `fichatec_notebook_marca_notebook` (`cod_marca_notebook`),
  ADD KEY `fichatec_notebook_modelo_notebook` (`cod_modelo_notebook`),
  ADD KEY `fichatec_notebook_linha_notebook` (`cod_linha_notebook`);
...
ALTER TABLE `fichatec_tablets`
  ADD PRIMARY KEY (`cod_ficha_tec`),
  ADD KEY `fichatec_tablets_cadastro_produto` (`cod_anuncio`),
...
--
ALTER TABLE `fichatec_celulares`
  MODIFY `cod_ficha_tec` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de tabela `fichatec_notebook`
--
ALTER TABLE `fichatec_notebook`
...
--
ALTER TABLE `linha_notebook`
  MODIFY `cod_linha_notebook` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
...
--
ALTER TABLE `modelo_notebook`
  MODIFY `cod_modelo_notebook` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=489;
...
--
-- Limitadores para a tabela `fichatec_notebook`
--
ALTER TABLE `fichatec_notebook`
  ADD CONSTRAINT `fichatec_notebook_cadastro_produto` FOREIGN KEY (`cod_anuncio`) REFERENCES `cadastro_produto` (`cod_produto`),
  ADD CONSTRAINT `fichatec_notebook_linha_notebook` FOREIGN KEY (`cod_linha_notebook`) REFERENCES `linha_notebook` (`cod_linha_notebook`),
  ADD CONSTRAINT `fichatec_notebook_marca_notebook` FOREIGN KEY (`cod_marca_notebook`) REFERENCES `marca_notebook` (`cod_marca_notebook`),
  ADD CONSTRAINT `fichatec_notebook_modelo_notebook` FOREIGN KEY (`cod_modelo_notebook`) REFERENCES `modelo_notebook` (`cod_modelo_notebook`);

--
-- Limitadores para a tabela `fichatec_tablets`
--
ALTER TABLE `fichatec_tablets`
  ADD CONSTRAINT `fichatec_tablets_cadastro_produto` FOREIGN KEY (`cod_anuncio`) REFERENCES `cadastro_produto` (`cod_produto`),
